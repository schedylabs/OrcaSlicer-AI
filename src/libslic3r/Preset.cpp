...
static std::vector<std::string> s_Preset_print_options {
    ...
    "elefant_foot_compensation", "elefant_foot_compensation_layers", "xy_contour_compensation", "xy_hole_compensation", "resolution", "enable_prime_tower", "prime_tower_enable_framework", "use_icf",
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "bridge_density","internal_bridge_density", "precise_outer_wall", "smooth_finish", "anti_ghost", "bridge_acceleration",
